...
type ImageLoaderConfig struct {
	...
	Fetch func(keys []string) ([]*models.Image, []error)
...
func (l *ImageLoader) Load(key string) (*models.Image, error) {
...
func (l *ImageLoader) LoadThunk(key string) func() (*models.Image, error) {
	l.mu.Lock()
...
func (l *ImageLoader) LoadAll(keys []string) ([]*models.Image, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *ImageLoader) LoadAllThunk(keys []string) func() ([]*models.Image, []error) {
	results := make([]func() (*models.Image, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *ImageLoader) Prime(key string, value *models.Image) bool {
	l.mu.Lock()
	var found bool
...
func (l *ImageLoader) Clear(key string) {
	l.mu.Lock()
	delete(l.cache, key)
	l.mu.Unlock()
}

func (l *ImageLoader) unsafeSet(key string, value *models.Image) {
	if l.cache == nil {
		l.cache = map[string]*models.Image{}
	}
	l.cache[key] = value
}
...
func (b *imageLoaderBatch) keyIndex(l *ImageLoader, key string) int {
