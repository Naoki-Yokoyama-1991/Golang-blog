...
type CommentLoader struct {
	...
	cache map[string]*models.Comment
...
func (l *CommentLoader) Load(key string) (*models.Comment, error) {
...
func (l *CommentLoader) LoadThunk(key string) func() (*models.Comment, error) {
	l.mu.Lock()
...
func (l *CommentLoader) LoadAll(keys []string) ([]*models.Comment, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *CommentLoader) LoadAllThunk(keys []string) func() ([]*models.Comment, []error) {
	results := make([]func() (*models.Comment, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *CommentLoader) Prime(key string, value *models.Comment) bool {
	l.mu.Lock()
	var found bool
...
func (l *CommentLoader) unsafeSet(key string, value *models.Comment) {
	if l.cache == nil {
		l.cache = map[string]*models.Comment{}
	}
	l.cache[key] = value
}
